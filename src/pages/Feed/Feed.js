...
class Feed extends Component {
  ...
  componentDidMount() {
    ...
    fetch('https://message-node2.herokuapp.com/graphql', {
      method: 'POST',
      headers: {
  ...
  finishEditHandler = postData => {
    ...
    fetch('https://message-node2.herokuapp.com/post-image', {
      method: 'PUT',
      headers: {
        Authorization: 'Bearer ' + this.props.token
      },
      ...
      .then(fileResData => {
        ...
        return fetch('https://message-node2.herokuapp.com/graphql', {
          method: 'POST',
          body: JSON.stringify(graphqlQuery),
          headers: {
            Authorization: 'Bearer ' + this.props.token,
